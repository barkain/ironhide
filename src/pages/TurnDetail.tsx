...
function TurnDetail() {
  ...
  if (!currentTurn) {
    return (
      <div className="flex flex-col">
        <Header title="Turn Not Found" subtitle={getProjectDisplayName(session.project_path)} />
        <div className="flex-1 p-6">
  ...
  return (
    <div className="flex flex-col h-full">
      <Header title={`Turn #${turnNumber}`} subtitle={getProjectDisplayName(session.project_path)} />
